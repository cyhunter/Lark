...
module lark.gui {
     ...
     */
    export class TextInput extends lark.TextInput implements UIComponent {
    ...
    player.implementUIComponent(TextInput, lark.TextInput);
    registerClass(TextInput, 1245, [Types.UIComponent]);
}